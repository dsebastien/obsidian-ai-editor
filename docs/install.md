...
- The `editor-ai-daemons:*` [command-line integration](command-line.md) is covered by the same floor: its API shipped in 1.12.2, below the version the plugin requires.
