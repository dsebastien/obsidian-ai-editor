...
![The Panels settings page: the Pre-publish Review panel card listing its four members and aggregation backend, with an enable toggle](images/panels-tab.png)
